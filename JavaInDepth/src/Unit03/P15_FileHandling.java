...
class ABCDEF {
	...
	void takeInputFromAFile() throws IOException {
		...
		String path = "C:\\Users\\hp\\git\\LearningJavaInDepth\\JavaInDepth\\src\\Unit03\\Input.txt";
...
//		}
	...
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\hp\\git\\LearningJavaInDepth\\JavaInDepth\\src\\Unit03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
